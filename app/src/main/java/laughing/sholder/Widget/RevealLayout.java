...
public class RevealLayout extends FrameLayout{
    ...
    private MainActivity.OnBackAnimationEnd listener;
    ...
    public void show(int x, int y, int duration) {
        Log.e(null,"x="+x+" y="+y+" getwidth()="+getWidth()+" getheight()="+getHeight());
    ...
    public void setAnimationEndListener(MainActivity.OnBackAnimationEnd lis){
        this.listener = lis;
    }
